...
public class EnchantmentGlimmering extends Enchantment{
    ...
    public EnchantmentGlimmering() {
        super(Enchantment.Rarity.UNCOMMON, EnchantmentTarget.ARMOR_FEET, new EquipmentSlot[]{EquipmentSlot.FEET,EquipmentSlot.HEAD,EquipmentSlot.CHEST,EquipmentSlot.LEGS});
    }
