...
public class ItemFilterScreen extends HandledScreen<ItemFilterScreenHandler> {
    ...
    private static final Identifier TEXTURE = new Identifier("partea_expansion", "textures/gui/item_filter.png");
    ...
    private static void sendModeRequest(boolean mode) {
        ...
        ClientPlayNetworking.send(new Identifier("partea_expansion", "filter_mode_request"), buf);
    }
