...
public class ModGoldenNetheriteArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_STATUS_EFFECT_INSTANCE_MAP =
            (new ImmutableMap.Builder<ArmorMaterial,StatusEffectInstance>())
                    .put(ModArmorMaterial.GOLDEN_NETHERITE,new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE,20,0,
                            false,false,false)).build();
    public ModGoldenNetheriteArmorItem(ArmorMaterial material, Type type, Settings settings) {
