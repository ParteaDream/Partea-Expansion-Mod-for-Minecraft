...
public class AzuriteCrossbowItem extends CrossbowItem {
    ...
    public AzuriteCrossbowItem(Settings settings) {
        super(settings);
    }
    ...
    public static PersistentProjectileEntity createArrow(World world, LivingEntity entity, ItemStack crossbow, ItemStack arrow) {
        ...
        persistentProjectileEntity.setDamage(persistentProjectileEntity.getDamage() * 0.6);
    ...
    public static float getSpeed(ItemStack stack) {
        return hasProjectile(stack, Items.FIREWORK_ROCKET) ? 3F : 8F;
    }
    @Override
