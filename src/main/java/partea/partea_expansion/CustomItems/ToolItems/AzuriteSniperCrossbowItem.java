...
public class AzuriteSniperCrossbowItem extends SniperCrossbowSeries{
    public AzuriteSniperCrossbowItem(Settings settings) {
        super(settings);
    }
    ...
    public static void clearProjectiles(ItemStack crossbow) {
        NbtCompound nbtCompound = crossbow.getNbt();
        if (nbtCompound != null && nbtCompound.getInt("proLeft") == 0) {
    ...
    public static void shootAll(World world, LivingEntity entity, Hand hand, ItemStack stack, float speed, float divergence) {
        ...
        divergence =  divergence * (1f - 0.9f * level);
    ...
    public static PersistentProjectileEntity createArrow(World world, LivingEntity entity, ItemStack crossbow, ItemStack arrow) {
        ...
        persistentProjectileEntity.setDamage(persistentProjectileEntity.getDamage() * 0.35);
    ...
    public static boolean loadProjectiles(LivingEntity shooter, ItemStack crossbow) {
    ...
    public static boolean loadProjectile(LivingEntity shooter, ItemStack crossbow, ItemStack projectile, boolean simulated, boolean creative) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (isCharged(itemStack)) {
            ...
            int a;
            if (nbtCompound != null) {
                a = nbtCompound.getInt("proLeft");
                nbtCompound.putInt("proLeft", a - 1);
                if (nbtCompound.getInt("proLeft") == 0){
    ...
    public static float getSpeed(ItemStack stack) {
        return hasProjectile(stack, Items.FIREWORK_ROCKET) ? 3F : 17F;
    }
    @Override
